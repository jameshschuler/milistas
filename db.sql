...
CREATE TABLE list_item (
    list_item_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    ...
    CONSTRAINT list_item_list_id_fkey FOREIGN KEY (list_id)
        REFERENCES public.list (list_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
	CONSTRAINT list_item_account_id_fkey FOREIGN KEY (account_id)
		REFERENCES public.account (account_id) MATCH SIMPLE
		ON UPDATE NO ACTION
		ON DELETE NO ACTION
);
